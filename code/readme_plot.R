...
ggsave("output/readmeplot.png",p1,width=4,height=5,units="in",dpi=300) #there is some guess work with the height and width ratio. I am not sure of the best way to do it. 
